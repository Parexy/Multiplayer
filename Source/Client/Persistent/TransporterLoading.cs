...
namespace Multiplayer.Client
{
    public class TransporterLoading : IExposable, ISessionWithTransferables
    {
        ...
        {
            MpLoadTransportersWindow dialog = new MpLoadTransportersWindow(map, transporters);
        ...
        public void OpenWindow(bool sound = true)
        {
            ...
            MpLoadTransportersWindow dialog = PrepareDummyDialog();
            if (!sound)
    ...
    public class MpLoadTransportersWindow : Dialog_LoadTransporters
    {
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            try
            {
                TransporterLoading session = Session;
