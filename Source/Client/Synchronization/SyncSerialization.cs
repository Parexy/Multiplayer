...
namespace Multiplayer.Client.Synchronization
{
    public static partial class Sync
    {
        ...
        private static readonly MethodInfo ReadExposable = AccessTools.Method(typeof(ScribeUtil), nameof(ScribeUtil.ReadExposable));
        ...
        public static object ReadSyncObject(ByteReader data, SyncType syncType)
        {
            ...
            try
            {
                ...
                if (readers.TryGetValue(type, out var reader)) return reader(data);
        ...
        public static void WriteSyncObject(ByteWriter data, object obj, SyncType syncType)
        {
            ...
            try
            {
                ...
                else if (typeof(CompChangeableProjectile) == type) // special case of ThingComp
                {
                    ...
                    {
                        var turretGun = compEquippable.AllVerbs.Select(v => v.caster).OfType<Building_TurretGun>().FirstOrDefault();
                        if (turretGun != null)
                        {
